...
const tileSize = 64;
const map = [
    ["road_cross","road_horizontal","road_horizontal","road_T","road_vertical","road_curve","road_vertical","road_vertical"],
    ["road_vertical","tree","tree","road_vertical","road_vertical","road_vertical","rock","road_vertical"],
    ["road_vertical","tree","tree","road_vertical","road_curve","road_horizontal","road_horizontal","road_cross"],
    ["road_T","road_horizontal","road_horizontal","road_horizontal","road_horizontal","road_horizontal","road_horizontal","road_T"]
];
...
function updateCar() {
    ...
    // Verificar colisión con bordes de canvas
